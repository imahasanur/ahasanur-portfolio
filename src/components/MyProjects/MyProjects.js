...
const MyProjects = () => {
    ...
    const modalExample = ["#example1", "#example2", "#example3", "#example4", "#example5"];
    ...
    return (
        <div className="projects-container">
            <div>
                <h2 className="text-center p-5 text-decoration-underline mb-5">My Projects</h2>
            </div>
            <div className="p-3">
                <div className="row container-fluid g-3">
                    <div className="col-11 col-sm-6 d-flex justify-content-center align-items-center mb-3">
                        ...
                        <div className="card-body">
                            ...
                            <h6 className="card-subtitle mb-2"> different bicycle services</h6>
                            <button onClick={()=>setExampleId(modalExample[0])} type="button" class="btn btn-dark p-2" data-toggle="modal" data-target={modalExample[0]} data-whatever="">view Details</button>
                    ...
                    <div className="card project-card">
                        ...
                        <div className="card-body">
                            ...
                            <h6 className="card-subtitle mb-2"> different books order</h6>
                            <button onClick={()=>setExampleId(modalExample[1])} type="button" class="btn btn-dark p-2" data-toggle="modal" data-target={modalExample[1]} data-whatever="">view Details</button>                    
                    ...
                    <div className="col-11 col-sm-6 d-flex justify-content-center align-items-center mb-3">
                        ...
                        <div className="card-body">
                            ...
                            <h6 className="card-subtitle mb-2"> get bookings of different transport</h6>
                            <button onClick={()=>setExampleId(modalExample[2])} type="button" class="btn btn-dark p-2" data-toggle="modal" data-target={modalExample[2]} data-whatever="">view Details</button>
                    ...
                    <div className="col-11 col-sm-6 d-flex justify-content-center align-items-center mb-3">
                        ...
                        <div className="card-body">
                            ...
                            <h6 className="card-subtitle mb-2"> showing different soccer league details by an api call</h6>
                            <button onClick={()=>setExampleId(modalExample[3])} type="button" class="btn btn-dark p-2" data-toggle="modal" data-target={modalExample[3]} data-whatever="">view Details</button>
                        </div>
                        </div>
                    </div>
                    <div className="col-11 col-sm-6 d-flex justify-content-center align-items-center mb-3">
                        ...
                        <div className="card-body">
                            ...
                            <h6 className="card-subtitle mb-2"> selected images sliding</h6>
                            <button onClick={()=>setExampleId(modalExample[4])} type="button" class="btn btn-dark p-2" data-toggle="modal" data-target={modalExample[4]} data-whatever="">view Details</button>
                        </div>
                        </div>
                    </div>
                </div>
         ...
         {/* for modal  */}
         <div class="modal fade" id={exampleId.slice(1,)} tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                ...
                <div class="modal-body">
                    {exampleId === "#example1" &&  <div className="card-body">
                            <h5 class="card-title">bicycle service web app </h5>
                            <h6 className="card-subtitle mb-2"> different bicycle services</h6>
                    ...
                    {exampleId === "#example2" &&                         <div className="card-body">
                            <h5 class="card-title">ebook store web app </h5>
                            <h6 className="card-subtitle mb-2"> different books order</h6>
                            <p className="card-text">
                                <ul>
                    ...
                    {exampleId === "#example3" &&  <div className="card-body">
                            <h5 class="card-title">eticket booking web app </h5>
                            <h6 className="card-subtitle mb-2"> get bookings of different transport</h6>
                            <p className="card-text">
                                <ul>
                    ...
                    {exampleId === "#example4" && <div className="card-body">
                            <h5 class="card-title">soccer league web app </h5>
                            <h6 className="card-subtitle mb-2"> showing different soccer league details by an api call</h6>
                            <p className="card-text">
                                <ul>
                    ...
                    {exampleId === "#example5" &&                         <div className="card-body">
                            <h5 class="card-title">fancy slider web app </h5>
                            <h6 className="card-subtitle mb-2"> selected images sliding</h6>
                            <p className="card-text">
                                <ul>
                                    <li>an api is called  search result</li>
